...
#========================================================================================================================
    ...
    async def on_message(self, message):
      if "<@816963491554131998>" in message.content:
            ...
            await message.channel.reply("> *Hi, <@816963491554131998> is no more active on discord servers- you could try dming / contact through other socials-- :dove:*", reference = message)
      else:
